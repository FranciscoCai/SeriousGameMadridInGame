...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSystem_Actions()
    {
        Debug.Assert(!m_PlayerOnGame.enabled, "This will cause a leak and performance issues, InputSystem_Actions.PlayerOnGame.Disable() has not been called.");
    ...
    public struct PlayerOnGameActions
    {
        ...
        public static implicit operator InputActionMap(PlayerOnGameActions set) { return set.Get(); }
        public void AddCallbacks(IPlayerOnGameActions instance)
        {
            if (instance == null || m_Wrapper.m_PlayerOnGameActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlayerOnGameActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPlayerOnGameActions instance)
        {
            @Look.started -= instance.OnLook;
            @Look.performed -= instance.OnLook;
            @Look.canceled -= instance.OnLook;
        ...
        public void RemoveCallbacks(IPlayerOnGameActions instance)
        {
            if (m_Wrapper.m_PlayerOnGameActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPlayerOnGameActions instance)
        {
            foreach (var item in m_Wrapper.m_PlayerOnGameActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlayerOnGameActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public PlayerOnGameActions @PlayerOnGame => new PlayerOnGameActions(this);
